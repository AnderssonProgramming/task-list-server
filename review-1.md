...
En palabras simples: es como el "almacén" ordenado donde viven todas tus tareas, listo para que cualquier app converse con él y le pida "dame mis tareas", "agrega esta nueva", "marca esta como hecha" o "borra esta otra".
...
Estas funcionalidades cubren el ciclo de vida completo de una tarea: crearla, consultarla, actualizarla y eliminarla, que es exactamente lo que cualquier persona espera de una app de productividad.
...
- **JSON**: es el formato en el que se envía y recibe la información (por ejemplo, la lista de tareas). Es un formato liviano y universal que cualquier aplicación web o móvil puede entender fácilmente.
